...
import { View ,Text,StyleSheet, TextInput, TouchableOpacity, TurboModuleRegistry,ScrollView} from "react-native";
...
const SignupScreen=({navigation})=>{
   ...
   const [emailfocus,setEamilfocus]=useState(false);
      ...
      { customError !== '' && <Text style={styles.errormsg}>{customError}</Text>}
           ...
           {/* start Password */}
            ...
            secureTextEntry={showpassword===false?true:false}
             />      
             <Octicons name={showpassword==false?"eye-closed":'eye'} size={24} color="black" onPress={()=> setShowpassword(!showcpassword)}/>
            </View>
             ...
             <View style={styles.inputout}>
              <MaterialCommunityIcons name="lock-outline" size={24} color={passwordcfocus===true? colors.text1:colors.text2}/>
             <TextInput style={styles.input} placeholder="Confrom Password"
             onFocus={()=>{
              setEamilfocus(false)
              setPasswordfocus(false)
            ...
            secureTextEntry={showcpassword===false?true:false}
             />
             {/* <Octicons name="eye" size={24} color={colors.text2}/> */}
             <Octicons name={showcpassword==false?"eye-closed":'eye'} size={24} color="black" onPress={()=> setcShowpassword(!showcpassword)}/>
            </View>
           
           <Text style={styles.address}>Please enter your addess</Text>
             <View style={styles.inputout}>
          ...
          <TouchableOpacity>
           <View style={styles.gficon}><AntDesign name="google" size={24} color='#EA4335'/>
           </View>
          </TouchableOpacity>
          <TouchableOpacity>
            <View style={styles.gficon}><FontAwesome5 name="facebook-f" size={24} color="#4267B2"/></View>
          </TouchableOpacity>
          </View>
           <View style={hr80}></View>
           <Text>Already have an account.
           <Text style={styles.signup} onPress={()=>navigation.navigate('login')}>  Sign in</Text></Text>
           </View>
                :
